...
4 participants across 2 groups. Testing was conducted on the final version of Mise-en-Lens (v4). All participants used the live deployed version with their own Letterboxd accounts or manual film entry.

## Participant Profiles

| ID | Group | Film Background | Letterboxd User |
|---|---|---|---|
| P1 | Undergraduate student | None (casual viewer) | Yes |
| P2 | Undergraduate student | None (casual viewer) | Yes |
| P3 | MAC department professor | High (domain expert) | Yes |
| P4 | Undergraduate student | Moderate (some coursework) | Yes |
...
MAC professor, high film expertise.
