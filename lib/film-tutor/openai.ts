...
function buildQuizPrompt(
  ...
  return [
    ...
    "Q5 (multiple_choice): Transfer VERIFY step — see transferConcept.verifyQuestion instructions.",
    "Q6 (short_answer): Transfer APPLY step — see transferConcept.applyQuestion instructions. maxWords: 18.",
